...
theorem IsAdicComplete.exists_isRoot_of_eval_mem {R : Type*} [CommRing R] {I : Ideal R}
    [IsAdicComplete I R] {f : R[X]} {a₀ : R} (h₁ : f.eval a₀ ∈ I)
      (h₂ : IsUnit (Ideal.Quotient.mk I ((derivative f).eval a₀))) :
...
instance (priority := 100) IsAdicComplete.henselianRing (R : Type*) [CommRing R] (I : Ideal R)
  ...
  is_henselian _ _ _ h₁ h₂ := IsAdicComplete.exists_isRoot_of_eval_mem h₁ h₂
